...
Prepend with /email and make sure its the same as you used for payment.)
  ...
  def join_group!(*)
      respond_with :message, text: "When you're ready, add your @username and brief description to your Telegram profile, and get started in our community 👋.", reply_markup: {
      inline_keyboard: [
